...
The implementation of the parallel sort is taken from the standard librare, [std.parallelism](https://dlang.org/phobos/std_parallelism.html#.task). It is well tested (I assume) so lets start by using it as is.
