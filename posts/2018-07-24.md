...
But the good thing is that we now have the infrastructure to create parallel `Variable`s! Lets do that. Lets implement that parallel sort. That surely should result in some markedly improvements.
